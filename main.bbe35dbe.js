...
function cellAt(grid, r, c, COLS) {
return (r >= 0 && c >= 0 && r < 4 && c < COLS) ? grid.children[r*COLS+c] : null;
}
function pickBg(grid, r, c, COLS, minDist) {
...
var n = cellAt(grid, r+dr, c+dc, COLS);
...
var bg = pickBg(grid, r, c, COLS, 48);
var hue = randHue([]);
var nearHue = [];
for (var dr = -1; dr <= 1; dr++) {
for (var dc = -1; dc <= 1; dc++) {
